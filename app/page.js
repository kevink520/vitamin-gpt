...
export default function Chat () {
  ...
  const {
    ...
    initialMessages: [
      {
        role: 'assistant',
        content: 'Hello, I am a helpful AI chatbot powered by GLM-5.2, a state-of-the-art open-weights, general-purpose AI model. I can also search the web. Ask me anything.'// a latest thinking AI model. I can also search the web. Ask me anything.'
      }
    ],
    onFinish: async (msg) => {
      if (msg.content) {
